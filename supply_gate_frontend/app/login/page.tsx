...
export default function LoginForm() {
    ...
    return (
        <div className="min-h-screen flex">
            {/* Left teal sidebar */}
            <div className="w-[240px] bg-[#1e4d5c] hidden md:block" />

            {/* Right content area */}
            <div className="flex-1 flex items-center justify-center bg-white p-8">
                <div className="w-full max-w-md">
                    {/* Title */}
                    <h1 className="text-3xl font-medium text-center mb-10 text-gray-800">Supply Gate</h1>
                    ...
                    <p className="text-center mt-6 text-gray-600">
                        ...
                        <Link href="#" className="text-[#1e4d5c] hover:underline">
                            sign up
                        </Link>
                    </p>
                </div>
