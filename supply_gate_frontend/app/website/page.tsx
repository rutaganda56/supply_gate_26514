...
import { ChevronDown, Globe, ArrowRight, Linkedin, Instagram, Twitter } from "lucide-react"
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="bg-[#1e4d5c] px-6 py-12">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-8">
                        ...
                        <Link href="#" className="text-white text-sm underline hover:no-underline">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="max-w-md mx-auto">
                        <p className="text-gray-600 text-sm leading-relaxed mb-6">
                            "When the pandemic hit, those of us who thrive on in-person collaboration were worried that our creativity
                            and productivity would suffer. Miro was the perfect tool to help us with collaboration whiteboarding, and
                            retrospectives while remote."
                        </p>
            ...
            <section className="px-6 py-12">
                <div className="max-w-2xl mx-auto bg-[#1e4d5c] rounded-2xl px-8 py-12 text-center">
                    ...
                    <Link href="#" className="text-white text-sm underline hover:no-underline mb-6 inline-block">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li>
                                    <Link href="/signUp" className="text-gray-300 text-sm hover:text-white">
